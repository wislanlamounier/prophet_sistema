<?php
	...
	/**
	 * Classe responsável pela impressão da agenda por consultório
	 *
	 * @author Rafael de Paula - <rafael@bentonet.com.br>
	 * @version 1.0.0 - 2015-10-06
	 *
	**/
	class PDFAgendaConsultorio extends FPDF{
		use PDF_trait;
        use Transformacao;
        private $datConsulta;
        ...
        **/
        public function Header(){
            ...
            $this->PutRow(array('Agenda do dia '.$this->getDatConsulta()), true);

            $yIni = $this->GetY();
            $this->SetFont('Arial', '', 12);
            $this->SetAligns(array('L', 'L', 'L', 'L'));
            $this->SetWidths(array(20, 105, 15, 50));
            $this->PutRow(array('Clinica: ', $_SESSION['nomClinica'], 'Tipo:', 'Por consultório'), true);
            $yFim = $this->GetY();
