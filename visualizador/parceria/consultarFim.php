                    <div class="col-md-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-header">
                                <a class="pull-right" href="<?php echo BASE_URL; ?>/parceria/cadastrar">
                                    <button class="btn btn-success">
                                        Cadastrar nova parceria
                                    </button>
                                </a>
                            </div>
                            <div class="ibox-content text-center p-md">
                                <div class="row">
                                    <div class="col-md-6 col-lg-3 form-group">
                                        ...
                                        <input class="form-control" name="nomParceria" type="text" value="<?php echo $dtoParceria->getNomParceria(); ?>">
                                    </div>
                                    <div class="col-md-6 col-lg-3 form-group">
                                        ...
                                        <input required name="indPaciente" value="2" type="radio" <?php echo !$dtoParceria->getIndPaciente() ? 'checked' : ''; ?>> Não
                                        <br>
                                        <br>
                                    </div>
                                    ...
                                    <tbody>
                                        <?php
                                            foreach($arrDependentes as $arrDependente){
                                                ...
                                                $arrPaciente = $modPaciente->getPaciente($arrDependente['cdnPaciente']);
                                                $arrPaciente['nomPaciente'] .= isset($arrPaciente['nomSobrenome']) ? ' '.$arrPaciente['nomSobrenome'] : '';
                                        ?>
                                            <tr>
                                                <td>
                                                    <?php echo $this->link('paciente', 'consultarFim', $arrPaciente['nomPaciente'], array($arrPaciente['cdnPaciente']));?>
                                                </td>
                                                <td>
                                                    <a href="<?php echo BASE_URL; ?>/paciente/consultarFim/<?php echo $arrPaciente['cdnPaciente']; ?>">
                                                        <button class="btn btn-success">
                        ...
                        ?>
                                <div class="col-md-4 col-md-offset-2">
                                    <a href="<?php echo BASE_URL; ?>/parceria/atualizar/<?php echo $dtoParceria->getCdnParceria(); ?>">
                                ...
                                <div class="col-md-4">
                                    <a href="<?php echo BASE_URL; ?>/parceria/preco/<?php echo $dtoParceria->getCdnParceria(); ?>">
                                ...
                                <div class="row text-justify">
                                    ...
                                    <div class="col-md-12">
                                        <span class="text-muted">
                                            <?php echo $this->link('parceria', 'deletar', 'Deletar parceria', array($dtoParceria->getCdnParceria())); ?>
                                        </span>
                                    </div>
