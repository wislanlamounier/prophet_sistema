                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-content text-center p-md">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h2>
                                            <span class="text-navy">Tem certeza que deseja deletar este usuário?</span>
                                        </h2>
                                        <h3>
                                            Esta ação não poderá ser desfeita. O usuário apenas obterá acesso novamente
                                ...
                                <div class="row text-center">
                                    ...
                                    <div class="col-sm-5 col-md-4 text-center">
                                        <a href="<?php echo BASE_URL; ?>/usuario/deletarFim/<?php echo $arrUsuario['cdnUsuario']; ?>">
