    <div class="ibox-header p-md">
        <div class="col-md-12">
            <h3 class="pull-left">Cadastrar aviso de SMS para <?php echo $nomPaciente; ?></h3>
    ...
    <div class="ibox-content p-md">
        <form action="<?php echo BASE_URL; ?>/consulta/cadastrarAvisoFim/<?php echo $cdnConsulta; ?>" method="post">
            <div class="row">
