                            ...
                            <div class="ibox-content p-md">
                                    ...
                                    <div class="col-md-12">
                                        <h2>
                                            <span class="text-navy">
                                                Tem certeza que deseja aprovar o orçamento no valor de R$<?php echo $dtoOrcamento->getValOrcamento(true); ?>
                                                para o paciente <?php echo $arrPaciente['nomPaciente']; ?>? <br>
                                ...
                                <div class="row text-center">
                                    ...
                                    <div class="col-sm-5 col-md-4 text-center">
                                        <a href="<?php echo BASE_URL; ?>/orcamento/reprovarFim/<?php echo $dtoOrcamento->getCdnOrcamento(); ?>">
