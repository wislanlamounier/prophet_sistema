                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-content text-center p-md">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h2>
                                            <span class="text-navy">Tem certeza que deseja confirmar a saída de consultório deste paciente?</span>
                                        </h2>
                                    </div>
                                </div>
                                <div class="row text-center">
                                    ...
                                    <div class="col-sm-5 col-md-4 text-center">
                                        <a href="<?php echo BASE_URL; ?>/cronometro/saidaFim/<?php echo $cdnCronometro; ?>">
